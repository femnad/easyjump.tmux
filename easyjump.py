...
def parse_args() -> None:
    ...
    global MODE, SMART_CASE, LABEL_CHARS, LABEL_ATTRS, TEXT_ATTRS, PRINT_COMMAND_ONLY, CURSOR_POS, REGIONS, AUTO_BEGIN_SELECTION, COPY_WORD, COPY_UNTIL_SPACE, COPY_LINE, PASTE_AFTER
    MODE = {
        "mouse": Mode.MOUSE,
        "xcopy": Mode.XCOPY,
